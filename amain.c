...
{
  fprintf(stdout,"PPM2FLI version 2.1 by Klaus Ehrenfried (C) 1995,2002\n");
...
int main (int argc, char *argv[])
{
  ...
  for (i=1; i < argc; i++)
      ...
      else if ((*ppa == '-') || (*ppa == '+'))
	{
	  ...
	  switch (*ppa)
	    {
	    case 'h':   print_usage(); print_help(); return(1);
